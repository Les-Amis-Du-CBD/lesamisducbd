            ...
            <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '22px' }}>
                ...
                {user?.role === 'buraliste' && (
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                        ...
                        <Field label="Numéro d'identification fiscale" optional hint="N° SIRET">
                ...
                {/* Birthday */}
                <Field label="Date de naissance" optional hint="(Ex. : 31/05/1970)">
                    <input type="text" placeholder="JJ/MM/AAAA" value={formData.birthday} onChange={(e) => setFormData({ ...formData, birthday: e.target.value })}
                        style={inputStyle} onFocus={(e) => e.target.style.borderColor = 'var(--accent-neon)'} onBlur={(e) => e.target.style.borderColor = '#D1D5DB'} />
                </Field>
