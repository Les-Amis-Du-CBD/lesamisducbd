...
export default function CgvClient({ globalContent, content }) {
    ...
    const cgvTitle = content?.hero?.title || "CGV";
    const cgvSubtitle = content?.hero?.subtitle || "Conditions Générales de Vente";
        ...
        <main className={styles.main}>
            ...
            <div className={styles.container}>
                <div className={styles.header}>
                    <h1 className={styles.title}>{cgvTitle}</h1>
                    <p className={styles.subtitle}>{cgvSubtitle}</p>
                </div>
