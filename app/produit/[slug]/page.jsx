...
export async function generateMetadata({ params }) {
    ...
    return {
        title: `${foundProduct.name} - Fleur CBD Premium | Les Amis du CBD`,
        description: foundProduct.description || `Découvrez ${foundProduct.name}, une fleur de CBD d'exception. Cultivée avec soin, arômes puissants.`,
        openGraph: {
            images: [foundProduct.image || '/images/og-image.jpg'],
        },
    };
}
